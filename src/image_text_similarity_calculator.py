...
from src.model.zero_shot_image_classification_model import ZeroShotImageClassificationModel, Input
...
class ImageTextSimilarityCalculator:
  ...
  def calculate(self, inputs: list[Input]) -> list[Number]:
    ...
    # For each of our predictions, calculate the distance between the
    # image and text embeddings
    return [
      self.distance_calculator.calculate_distance(
